...
import { surahNames, surahPageMap,surahAyahCounts, juzData, getSurahNameByPage,dailyAyahs,dailyAhadith,allahNamesData } from './constants';
...
window.toggleRadio = function() {
    ...
    audio.play().then(updateUIOnSuccess).catch(() => { tryBackup(); });
