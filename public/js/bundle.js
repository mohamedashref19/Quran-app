...
exports.verifyOTP = exports.updateSettings = exports.signup = exports.showAlert = exports.resetPassword = exports.logout = exports.login = exports.forgotPassword = exports.deleteUser = void 0;
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  var markup = "<div class=\"alert alert-".concat(type === 'success' ? 'success' : 'danger', " alert-dismissible fade show position-fixed top-0 start-50 translate-middle-x mt-3 shadow\" role=\"alert\" style=\"z-index: 9999;\">\n    ").concat(msg, "\n    <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button>\n  </div>");
...
var verifyOTP = exports.verifyOTP = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(email, otp) {
    var res, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 2:
          _context3.p = 2;
          _t3 = _context3.v;
          showAlert('error', _t3.response.data.message);
        case 3:
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 2:
          ...
          console.log(res);
          if (res.data.status === "success") {
            showAlert("success", "".concat(type.toUpperCase(), " Update Successfuly"));
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
        ...
        case 3:
          _context5.p = 3;
          _t5 = _context5.v;
          showAlert("error", _t5.response.data.message);
        case 4:
          return _context5.a(2);
      }
    }, _callee5, null, [[1, 3]]);
  }));
  return function updateSettings(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var forgotPassword = exports.forgotPassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(email) {
    var res, _t6;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        ...
        case 2:
          _context6.p = 2;
          _t6 = _context6.v;
          showAlert('error', _t6.response.data.message);
        case 3:
          return _context6.a(2);
      }
    }, _callee6, null, [[0, 2]]);
  }));
  return function forgotPassword(_x1) {
    return _ref6.apply(this, arguments);
  };
}();
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(token, password, passwordConfirm) {
    var res, _t7;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        ...
        case 2:
          _context7.p = 2;
          _t7 = _context7.v;
          showAlert('error', _t7.response.data.message);
        case 3:
...
},{"axios":"../../node_modules/axios/index.js"}],"features.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkRecitation = checkRecitation;
exports.createKhatmah = createKhatmah;
exports.deleteBookmark = deleteBookmark;
exports.deleteKhatmah = deleteKhatmah;
exports.initSearch = void 0;
exports.loadBookmarks = loadBookmarks;
exports.loadPrayers = loadPrayers;
exports.loadQuranPage = loadQuranPage;
exports.loadReciters = loadReciters;
exports.loadSurahs = loadSurahs;
exports.manageKhatmah = manageKhatmah;
exports.startSurahReading = startSurahReading;
exports.toggleBookmark = toggleBookmark;
exports.updateKhatmahProgress = updateKhatmahProgress;
var _axios = _interopRequireDefault(require("axios"));
...
function loadQuranPage(_x) {
  return _loadQuranPage.apply(this, arguments);
}
function _loadQuranPage() {
  _loadQuranPage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(pageNumber) {
    var res, _res$data$data, ayahs, khatmah, pageNum, userBookmarks, isLoggedIn, bookmarkRes, titleElem, container, fullTextHTML, navButtons, _t4, _t5;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
        ...
        case 1:
          res = _context3.v;
          _res$data$data = res.data.data, ayahs = _res$data$data.ayahs, khatmah = _res$data$data.khatmah;
          pageNum = parseInt(pageNumber);
          currentPage = pageNum;
          userBookmarks = [];
          isLoggedIn = document.getElementById('logoutBtn') !== null;
          if (!isLoggedIn) {
            _context3.n = 5;
            break;
          }
        ...
        case 5:
          if (ayahs.length > 0) {
            document.title = "".concat(ayahs[0].surahNameAr, " - \u0635\u0641\u062D\u0629 ").concat(pageNum);
          }
          titleElem = document.getElementById('surah-name');
          if (titleElem) titleElem.innerText = "".concat(ayahs[0].surahNameAr || '...');
        ...
        case 6:
          ...
          ayahs.forEach(function (ayah) {
            ...
            var isBookmarked = userBookmarks.some(function (b) {
              return parseInt(b.surah) === ayah.surahNumber && parseInt(b.ayah) === ayahNum;
            });
            var iconClass = isBookmarked ? 'fas' : 'far';
            var iconColor = isBookmarked ? '#d4af37' : '#ccc';
            var isKhatmahActive = false;
            ...
            var khatmahClass = isKhatmahActive ? 'fas' : 'far';
            var khatmahColor = isKhatmahActive ? '#198754' : '#28a745';
            fullTextHTML += "\n            <span class=\"ayah-text ayah-clickable\" data-surah=\"".concat(ayah.surahNumber, "\" data-ayah=\"").concat(ayahNum, "\" title=\"\u062A\u0641\u0633\u064A\u0631 \u0627\u0644\u0622\u064A\u0629 ").concat(ayahNum, "\" style=\"cursor: pointer;\">").concat(ayahText, "</span>\n            <span class=\"ayah-end-wrapper\" style=\"white-space: nowrap; display: inline-block;\">\n                <span class=\"ayah-end-symbol\" style=\"color: #d4af37; font-family: sans-serif; margin: 0 5px; border: 1px solid #d4af37; border-radius: 50%; padding: 0 5px; font-size: 0.8em;\">").concat(ayahNum, "</span>\n                <i class=\"").concat(iconClass, " fa-bookmark bookmark-icon-btn\" data-surah=\"").concat(ayah.surahNumber, "\" data-ayah=\"").concat(ayahNum, "\" title=\"\u062D\u0641\u0638 \u0639\u0644\u0627\u0645\u0629 \u0645\u0631\u062C\u0639\u064A\u0629\" style=\"cursor: pointer; color: ").concat(iconColor, "; font-size: 0.7em;\"></i>\n            </span>\n            <i class=\"").concat(khatmahClass, " fa-flag khatmah-icon-btn mx-1\" data-surah=\"").concat(ayah.surahNumber, "\" data-ayah=\"").concat(ayah.ayahNumber, "\" title=\"").concat(isKhatmahActive ? 'أنت تتوقف هنا' : 'تحديث الختمة هنا', "\" style=\"cursor: pointer; color: ").concat(khatmahColor, "; font-size: 0.8em;\"></i>\n        ");
          });
          fullTextHTML += '</div><div class="text-center mt-3 text-muted small">- ' + pageNum + ' -</div>';
          container.innerHTML = fullTextHTML;
          navButtons = document.querySelectorAll('.nav-prev, .nav-next, #prev-surah-mobile, #next-surah-mobile');
          navButtons.forEach(function (btn) {
            return btn.classList.remove('d-none');
          });
...
function startSurahReading(surahNumber) {
  var sNum = parseInt(surahNumber);
  var startPage = surahStartPages[sNum] || 1;
  loadQuranPage(startPage);
}
function loadSurahs() {
  return _loadSurahs.apply(this, arguments);
}
function _loadSurahs() {
  _loadSurahs = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
    var res, container, surahsList, _t6;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
        ...
        case 2:
          ...
          surahsList.forEach(function (surah) {
            var surahNum = surah.number || surah.surahNumber || surahsList.indexOf(surah) + 1;
            var startPage = surahStartPages[surahNum] || 1;
            var html = "\n        <div class=\"col-md-3 mb-3\">\n          <a href=\"/quran/".concat(startPage, "\" class=\"text-decoration-none\"> <div class=\"card h-100 hover-shadow border-0 shadow-sm\">\n              <div class=\"card-body text-center\">\n                <div class=\"d-flex justify-content-center align-items-center mb-2\">\n                  <span class=\"badge bg-success rounded-circle p-2 me-2\">").concat(surahNum, "</span>\n                  <h5 class=\"card-title text-dark mb-0 fw-bold\" style=\"font-family: 'Amiri', serif;\"> ").concat(surah.arabicName, "</h5>\n                </div>\n                <p class=\"text-muted small mb-0\">\u0639\u062F\u062F \u0627\u0644\u0622\u064A\u0627\u062A: ").concat(surah.ayahCount, "</p>\n              </div>\n            </div>\n          </a>\n        </div>");
...
function toggleBookmark(_x2, _x3, _x4) {
  return _toggleBookmark.apply(this, arguments);
}
function _toggleBookmark() {
  _toggleBookmark = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(surah, ayah, iconElement) {
    var isLoggedIn, res, _t7;
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          isLoggedIn = document.getElementById('logoutBtn') !== null;
          ...
          return _context5.a(2, (0, _auth.showAlert)('error', 'يجب تسجيل الدخول أولاً لحفظ العلامات المرجعية'));
        case 1:
          _context5.p = 1;
          _context5.n = 2;
        ...
        case 2:
          ...
          if (res.data.message === 'added') {
            ...
            (0, _auth.showAlert)('success', 'تم إزالة العلامة المرجعية');
          }
          _context5.n = 4;
          break;
        case 3:
          _context5.p = 3;
          _t7 = _context5.v;
          (0, _auth.showAlert)('error', 'يرجى تسجيل الدخول لتتمكن من حفظ موضعك في المصحف الشريف. ');
        case 4:
          return _context5.a(2);
      }
    }, _callee5, null, [[1, 3]]);
...
function loadBookmarks() {
  return _loadBookmarks.apply(this, arguments);
}
function _loadBookmarks() {
  _loadBookmarks = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
    var res, container, bookmarks, _t8;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          _context6.p = 0;
        ...
        case 2:
          container.innerHTML = '';
          bookmarks = res.data.data.bookmarks; // console.log("Bookmarks Loaded:", bookmarks); 
        ...
        case 3:
          bookmarks.forEach(function (b) {
            var surahNum = parseInt(b.surah);
            var targetPage = b.page ? parseInt(b.page) : null;
            ...
            var html = "\n        <div class=\"col-md-6 mb-3\">\n          <div class=\"card shadow-sm border-start border-success border-4 h-100\">\n            <div class=\"card-body\">\n              <div class=\"d-flex justify-content-between align-items-start\">\n                <h5 class=\"card-title text-success\">".concat(b.surahName, "</h5>\n                <button class=\"btn btn-sm btn-outline-danger delete-bookmark-btn\" data-id=\"").concat(b._id, "\"><i class=\"fas fa-trash\"></i></button>\n              </div>\n              <p class=\"ayah-text text-dark mt-2\" style=\"font-family: 'Amiri'; font-size: 1.2rem;\">").concat(b.ayahText, "</p>\n              <div class=\"mt-3 d-flex justify-content-between align-items-center\">\n                <span class=\"badge bg-light text-dark\">\u0622\u064A\u0629 \u0631\u0642\u0645: ").concat(b.ayah, "</span>\n                \n                <a href=\"/quran/").concat(targetPage, "\" class=\"btn btn-sm btn-success\">\n                   <i class=\"fas fa-book-open me-1\"></i> \u0627\u0646\u062A\u0642\u0644 \u0644\u0644\u0622\u064A\u0629\n                </a>\n                \n              </div>\n            </div>\n          </div>\n        </div>");
            container.insertAdjacentHTML('beforeend', html);
          });
          _context6.n = 5;
          break;
...
function deleteBookmark(_x5) {
  return _deleteBookmark.apply(this, arguments);
}
function _deleteBookmark() {
  _deleteBookmark = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(id) {
    var _t9;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        case 0:
          _context7.p = 0;
          _context7.n = 1;
          return _axios.default.delete("/api/v1/bookmarks/".concat(id));
        case 1:
          (0, _auth.showAlert)('success', 'تم الحذف بنجاح');
          loadBookmarks();
          _context7.n = 3;
          break;
        case 2:
          _context7.p = 2;
          _t9 = _context7.v;
          (0, _auth.showAlert)('error', 'فشل الحذف');
        case 3:
          return _context7.a(2);
      }
    }, _callee7, null, [[0, 2]]);
...
function manageKhatmah() {
  return _manageKhatmah.apply(this, arguments);
}
function _manageKhatmah() {
  _manageKhatmah = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
    var res, activeDiv, k, msg, sIdx, surahName, statusText, progress, progressBar, createDiv, _t0;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        case 0:
          _context8.p = 0;
        ...
        case 2:
          ...
          msg = res.data.data.message || "واصل تقدمك لختم القرآن الكريم ✨";
          document.getElementById('daily-target').innerText = msg;
          sIdx = parseInt(k.currentSurah) - 1;
          surahName = surahNames[sIdx] || "\u0633\u0648\u0631\u0629 ".concat(k.currentSurah);
          statusText = document.getElementById('khatmah-status-text');
          if (statusText) {
            statusText.innerHTML = "\u0623\u0646\u062A \u0645\u062A\u0648\u0642\u0641 \u0639\u0646\u062F <strong>\u0633\u0648\u0631\u0629 ".concat(surahName, "</strong> - \u0622\u064A\u0629 <strong>").concat(k.currentAyah, "</strong>");
          }
          ...
          progress = Math.round(parseInt(k.currentSurah) / 114 * 100);
          progressBar = document.getElementById('progress-bar');
          if (progressBar) {
            progressBar.style.width = "".concat(progress, "%");
            progressBar.innerText = "".concat(progress, "%");
          }
          _context8.n = 4;
          break;
        case 3:
...
function createKhatmah(_x6, _x7) {
  return _createKhatmah.apply(this, arguments);
}
function _createKhatmah() {
  _createKhatmah = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(name, durationDays) {
    var res, _t1;
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.p = _context9.n) {
        ...
        case 2:
          _context9.p = 2;
          _t1 = _context9.v;
          (0, _auth.showAlert)('error', _t1.response.data.message);
        case 3:
...
function updateKhatmahProgress(_x8, _x9) {
  return _updateKhatmahProgress.apply(this, arguments);
}
function _updateKhatmahProgress() {
  _updateKhatmahProgress = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(surah, ayah) {
    var res, progressBar, newProgress, dailyTarget, targetMsg, statusText, sIdx, surahName, _t10;
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        ...
        case 1:
          res = _context0.v;
          if (res.data.status === 'success') {
            (0, _auth.showAlert)('success', 'تم تحديث موقع الختمة! 🚩');
            progressBar = document.getElementById('progress-bar');
            if (progressBar) {
              newProgress = Math.round(parseInt(surah) / 114 * 100);
              progressBar.style.width = "".concat(newProgress, "%");
              progressBar.innerText = "".concat(newProgress, "%");
            }
            dailyTarget = document.getElementById('daily-target');
            if (dailyTarget) {
              targetMsg = res.data.data && res.data.data.message || "واصل تقدمك ✨";
            ...
            statusText = document.getElementById('khatmah-status-text');
            if (statusText) {
              sIdx = parseInt(surah) - 1;
              surahName = surahNames[sIdx] || "\u0633\u0648\u0631\u0629 \u0631\u0642\u0645 ".concat(surah);
              statusText.innerHTML = "\u0623\u0646\u062A \u0645\u062A\u0648\u0642\u0641 \u0639\u0646\u062F <strong>\u0633\u0648\u0631\u0629 ".concat(surahName, "</strong> - \u0622\u064A\u0629 <strong>").concat(ayah, "</strong>");
            }
          }
          _context0.n = 3;
          break;
        case 2:
          _context0.p = 2;
          _t10 = _context0.v;
          console.error("❌ خطأ في التحديث:", _t10);
          (0, _auth.showAlert)('error', 'حدث خطأ، يرجى المحاولة مرة أخرى.');
        case 3:
...
function deleteKhatmah() {
  return _deleteKhatmah.apply(this, arguments);
}
function _deleteKhatmah() {
  _deleteKhatmah = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
    var res, activeDiv, createDiv, statusText, _t11;
    return _regenerator().w(function (_context1) {
      while (1) switch (_context1.p = _context1.n) {
        case 0:
          _context1.p = 0;
          _context1.n = 1;
          return _axios.default.delete('/api/v1/khatmah');
        case 1:
          res = _context1.v;
          if (res.status === 204) {
            (0, _auth.showAlert)('success', 'تم إلغاء الختمة بنجاح 🗑️');
            activeDiv = document.getElementById('active-khatmah');
            createDiv = document.getElementById('create-khatmah');
        ...
        case 2:
          _context1.p = 2;
          _t11 = _context1.v;
          (0, _auth.showAlert)('error', 'فشل إلغاء الختمة');
        case 3:
...
window.playCorrectAudio = function (surah, ayah) {
  var s = surah.toString().padStart(3, '0');
  var a = ayah.toString().padStart(3, '0');
  var audioUrl = "https://everyayah.com/data/Husary_Muallim_128kbps/".concat(s).concat(a, ".mp3");
  var audio = new Audio(audioUrl);
  audio.play().catch(function () {
    return (0, _auth.showAlert)('error', 'عذراً، فشل تشغيل الصوت التعليمي');
  });
};
...
window.playCorrectAudio = function (surah, ayah, btnElement) {
  ...
  var audioUrl = "https://everyayah.com/data/Minshawy_Murattal_128kbps/".concat(s).concat(a, ".mp3");
...
function checkRecitation(_x0, _x1, _x10, _x11, _x12) {
  return _checkRecitation.apply(this, arguments);
}
function _checkRecitation() {
  _checkRecitation = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(file, surah, startAyah, endAyah, userAudioUrl) {
    var formData, feedbackElem, res, _res$data, analysis, score, stats, resultHTML, _t12;
    return _regenerator().w(function (_context10) {
      while (1) switch (_context10.p = _context10.n) {
        case 0:
          ...
          _context10.p = 1;
          feedbackElem = document.getElementById('ai-feedback');
        ...
        case 2:
          res = _context10.v;
          _res$data = res.data, analysis = _res$data.analysis, score = _res$data.score, stats = _res$data.stats;
          resultHTML = "\n        <div class=\"mb-4 text-center\">\n        <h3 class=\"fw-bold\">\u062F\u0642\u0629 \u0627\u0644\u062A\u0644\u0627\u0648\u0629: ".concat(score, "%</h3>\n        <div class=\"progress mx-auto mb-3\" style=\"height: 12px; width: 70%; border-radius: 10px;\">\n            <div class=\"progress-bar bg-success\" style=\"width: ").concat(score, "%\"></div>\n        </div>\n            \n            <div class=\"audio-playback-container p-3 bg-light rounded-pill d-inline-block shadow-sm mb-3\">\n            <p class=\"small text-success fw-bold mb-2\"><i class=\"fas fa-play-circle me-1\"></i> \u0627\u0633\u062A\u0645\u0639 \u0625\u0644\u0649 \u062A\u0644\u0627\u0648\u062A\u0643:</p>\n            <audio controls src=\"").concat(userAudioUrl, "\" class=\"custom-audio-player\" style=\"height: 35px; width: 100%;\"></audio>\n        </div>\n    </div>\n\n       <div class=\"ai-result-box p-3 bg-white border rounded shadow-sm mb-4\">\n    ");
          analysis.forEach(function (item) {
            if (item.status === 'ayah_marker') {
              resultHTML += "\n            <div class=\"ayah-marker-wrapper d-inline-flex align-items-center align-middle\">\n                <span class=\"ayah-circle\">".concat(item.text, "</span>\n                <i class=\"fas fa-volume-up text-primary ms-1 listen-icon\" \n                   onclick=\"window.playCorrectAudio(").concat(item.surah, ", ").concat(item.ayah, ", this)\"\n                   style=\"cursor: pointer; font-size: 1rem;\" \n                   title=\"\u0627\u0633\u062A\u0645\u0639 \u0644\u0644\u0646\u0637\u0642 \u0627\u0644\u0635\u062D\u064A\u062D\"></i>\n            </div>");
            } else {
              var className = item.status === 'Correct' ? 'word-correct' : item.status === 'missing' ? 'word-missing' : 'word-wrong';
              resultHTML += "<span class=\"".concat(className, "\">").concat(item.text, "</span>");
            }
          });
        ...
        case 3:
          _context10.p = 3;
          _t12 = _context10.v;
          (0, _auth.showAlert)('error', 'عذراً، تعذر الاتصال بالشبكة. يرجى التحقق من الإنترنت والمحاولة مرة أخرى.');
...
function loadReciters() {
  return _loadReciters.apply(this, arguments);
}
function _loadReciters() {
  _loadReciters = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
    var res, container, recitersList, _surahNames, reciterNamesAr, optionsHTML, _container, _t13;
    return _regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        ...
        case 2:
          container.innerHTML = '';
          recitersList = res.data.data.reciters;
          ...
          return _context11.a(2);
        case 3:
          _surahNames = ["الفاتحة", "البقرة", "آل عمران", "النساء", "المائدة", "الأنعام", "الأعراف", "الأنفال", "التوبة", "يونس", "هود", "يوسف", "الرعد", "إبراهيم", "الحجر", "النحل", "الإسراء", "الكهف", "مريم", "طه", "الأنبياء", "الحج", "المؤمنون", "النور", "الفرقان", "الشعراء", "النمل", "القصص", "العنكبوت", "الروم", "لقمان", "السجدة", "الأحزاب", "سبأ", "فاطر", "يس", "الصافات", "ص", "الزمر", "غافر", "فصلت", "الشورى", "الزخرف", "الدخان", "الجاثية", "الأحقاف", "محمد", "الفتح", "الحجرات", "ق", "الذاريات", "الطور", "النجم", "القمر", "الرحمن", "الواقعة", "الحديد", "المجادلة", "الحشر", "الممتحنة", "الصف", "الجمعة", "المنافقون", "التغابن", "الطلاق", "التحريم", "الملك", "القلم", "الحاقة", "المعارج", "نوح", "الجن", "المزمل", "المدثر", "القيامة", "الإنسان", "المرسلات", "النبأ", "النازعات", "عبس", "التكوير", "الإنفطار", "المطففين", "الإنشقاق", "البروج", "الطارق", "الأعلى", "الغاشية", "الفجر", "البلد", "الشمس", "الليل", "الضحى", "الشرح", "التين", "العلق", "القدر", "البينة", "الزلزلة", "العاديات", "القارعة", "التكاثر", "العصر", "الهمزة", "الفيل", "قريش", "الماعون", "الكوثر", "الكافرون", "النصر", "المسد", "الإخلاص", "الفلق", "الناس"];
          reciterNamesAr = {
          ...
          optionsHTML = '';
          _surahNames.forEach(function (name, index) {
            optionsHTML += "<option value=\"".concat(index + 1, "\">").concat(index + 1, ". ").concat(name, "</option>");
          });
          recitersList.forEach(function (reciter) {
            var displayName = reciterNamesAr[reciter.name] || reciter.name;
            var serverUrl = reciter.server.endsWith('/') ? reciter.server.slice(0, -1) : reciter.server;
            var html = "\n        <div class=\"col-md-4 col-sm-6\">\n          <div class=\"card h-100 shadow-sm border-0\">\n            <div class=\"card-body text-center\">\n              <div class=\"mb-3\">\n                 <i class=\"fas fa-user-circle fa-3x text-success\"></i>\n              </div>\n              <h5 class=\"card-title fw-bold text-dark\">".concat(displayName, "</h5>\n              <p class=\"small text-muted mb-3\">", 'رواية حفص عن عاصم', "</p>\n              \n              <div class=\"form-group mb-3\">\n                <select class=\"form-select surah-select\" style=\"font-family: 'Amiri'\" data-server=\"").concat(serverUrl, "\">\n                   ").concat(optionsHTML, "\n                </select>\n              </div>\n\n              <audio controls class=\"w-100 mt-2 quran-player\" preload=\"none\">\n                <source src=\"").concat(serverUrl, "/001.mp3\" type=\"audio/mpeg\">\n                \u0645\u062A\u0635\u0641\u062D\u0643 \u0644\u0627 \u064A\u062F\u0639\u0645 \u062A\u0634\u063A\u064A\u0644 \u0627\u0644\u0635\u0648\u062A.\n              </audio>\n            </div>\n          </div>\n        </div>");
            container.insertAdjacentHTML('beforeend', html);
          });
          document.querySelectorAll('.surah-select').forEach(function (select) {
            select.addEventListener('change', function () {
              var surahNum = this.value;
              var server = this.dataset.server;
              var paddedSurah = surahNum.toString().padStart(3, '0');
              var newAudioUrl = "".concat(server, "/").concat(paddedSurah, ".mp3");
              var audioPlayer = this.parentElement.parentElement.querySelector('audio');
              if (audioPlayer) {
        ...
        case 4:
          _context11.p = 4;
          _t13 = _context11.v;
          console.error("Error loading reciters:", _t13);
          _container = document.getElementById('reciters-container');
          if (_container) _container.innerHTML = '<p class="text-danger text-center">حدث خطأ في تحميل القراء.</p>';
        case 5:
          return _context11.a(2);
      }
    }, _callee11, null, [[0, 4]]);
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(/*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(position) {
        var _position$coords, latitude, longitude, res, timings, container, cityRes, address, cityName, prayerNamesAr, _i, _Object$entries, _Object$entries$_i, key, value, name, html, _t, _t2;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _context.p = 0;
            ...
            case 2:
              ...
              _context.p = 3;
              _context.n = 4;
              return _axios.default.get("/api/v1/prayers/get-location?lat=".concat(latitude, "&lon=").concat(longitude));
            case 4:
              cityRes = _context.v;
              address = cityRes.data.data.address;
              cityName = address.city || address.town || address.village || address.state || "موقعك الحالي";
              document.getElementById('location-name').innerText = "\u0645\u0648\u0627\u0642\u064A\u062A \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064A ".concat(cityName);
              _context.n = 6;
              break;
            case 5:
              _context.p = 5;
            ...
            case 6:
              ...
              for (_i = 0, _Object$entries = Object.entries(timings); _i < _Object$entries.length; _i++) {
                ...
                html = "\n            <div class=\"list-group-item d-flex justify-content-between align-items-center\">\n              <span class=\"fw-bold\">".concat(name, "</span>\n              <span class=\"badge bg-success rounded-pill\" style=\"font-family: sans-serif\">").concat(value, "</span>\n            </div>");
                container.insertAdjacentHTML('beforeend', html);
              }
              _context.n = 8;
              break;
...
var initSearch = exports.initSearch = function initSearch() {
  ...
  searchInput.addEventListener('input', function (e) {
    ...
    timeoutId = setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var res, ayahs, _t3;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            ...
            _context2.n = 1;
            return _axios.default.get("/api/v1/quran/search?q=".concat(query));
          case 1:
            res = _context2.v;
          ...
          case 2:
            ayahs.forEach(function (ayah) {
              ...
              var realAyahNum = ayah.ayahNumber || ayah.numberInSurah;
              item.innerHTML = "\n            <div class=\"d-flex justify-content-between align-items-center\">\n              <span class=\"fw-bold text-success small\">".concat(ayah.surahNameAr, " - \u0622\u064A\u0629 ").concat(realAyahNum, "</span>\n              <span class=\"badge bg-light text-dark border\">\u0635 ").concat(ayah.page, "</span>\n            </div>\n            <p class=\"mb-0 mt-1 small text-muted text-end\" style=\"font-family: 'Amiri'; font-size: 1.1em;\">").concat(ayah.text.substring(0, 60), "...</p>\n          ");
              item.addEventListener('click', function (e) {
                e.preventDefault();
                var targetPage = ayah.page;
                if (window.location.pathname.includes('/quran/')) {
                  loadQuranPage(targetPage);
                  window.history.pushState({}, '', "/quran/".concat(targetPage));
                } else {
                  window.location.assign("/quran/".concat(targetPage));
                }
                resultsContainer.classList.add('d-none');
                searchInput.value = '';
              });
...
},{"axios":"../../node_modules/axios/index.js","./auth":"auth.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var currentPage = parseInt(window.location.pathname.split('/').pop()) || 1;
var surahNames = ["الفاتحة", "البقرة", "آل عمران", "النساء", "المائدة", "الأنعام", "الأعراف", "الأنفال", "التوبة", "يونس", "هود", "يوسف", "الرعد", "إبراهيم", "الحجر", "النحل", "الإسراء", "الكهف", "مريم", "طه", "الأنبياء", "الحج", "المؤمنون", "النور", "الفرقان", "الشعراء", "النمل", "القصص", "العنكبوت", "الروم", "لقمان", "السجدة", "الأحزاب", "سبأ", "فاطر", "يس", "الصافات", "ص", "الزمر", "غافر", "فصلت", "الشورى", "الزخرف", "الدخان", "الجاثية", "الأحقاف", "محمد", "الفتح", "الحجرات", "ق", "الذاريات", "الطور", "النجم", "القمر", "الرحمن", "الواقعة", "الحديد", "المجادلة", "الحشر", "الممتحنة", "الصف", "الجمعة", "المنافقون", "التغابن", "الطلاق", "التحريم", "الملك", "القلم", "الحاقة", "المعارج", "نوح", "الجن", "المزمل", "المدثر", "القيامة", "الإنسان", "المرسلات", "النبأ", "النازعات", "عبس", "التكوير", "الإنفطار", "المطففين", "الإنشقاق", "البروج", "الطارق", "الأعلى", "الغاشية", "الفجر", "البلد", "الشمس", "الليل", "الضحى", "الشرح", "التين", "العلق", "القدر", "البينة", "الزلزلة", "العاديات", "القارعة", "التكاثر", "العصر", "الهمزة", "الفيل", "قريش", "الماعون", "الكوثر", "الكافرون", "النصر", "المسد", "الإخلاص", "الفلق", "الناس"];
var goToNextPage = function goToNextPage() {
  if (currentPage < 604) {
    currentPage++;
    (0, _features.loadQuranPage)(currentPage);
    window.history.pushState({}, '', "/quran/".concat(currentPage));
  }
};
...
var ayahsContainer = document.getElementById('ayahs-container');
if (ayahsContainer) {
  var touchstartX = 0;
  var touchendX = 0;
  ...
  ayahsContainer.addEventListener('touchend', function (e) {
  ...
  ayahsContainer.addEventListener('click', function (e) {
    var tafseerTarget = e.target.closest('.ayah-clickable');
    if (tafseerTarget) window.showTafseer(tafseerTarget.dataset.surah, tafseerTarget.dataset.ayah);
    var bookmarkBtn = e.target.closest('.bookmark-icon-btn');
    if (bookmarkBtn) (0, _features.toggleBookmark)(bookmarkBtn.dataset.surah, bookmarkBtn.dataset.ayah, bookmarkBtn);
    var khatmahBtn = e.target.closest('.khatmah-icon-btn');
    if (khatmahBtn) {
      khatmahBtn.classList.replace('far', 'fas');
      (0, _features.updateKhatmahProgress)(khatmahBtn.dataset.surah, khatmahBtn.dataset.ayah);
    }
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _auth.login)(document.getElementById('email').value, document.getElementById('password').value);
  });
}
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _auth.signup)(document.getElementById('name').value, document.getElementById('email').value, document.getElementById('password').value, document.getElementById('passwordConfirm').value);
  });
}
var verifyOTPForm = document.querySelector('#verifyOTPForm');
if (verifyOTPForm) {
  verifyOTPForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _auth.verifyOTP)(document.getElementById('email').value, document.getElementById('otp').value);
  });
}
var userDataForm = document.querySelector('#updateUserForm');
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _auth.updateSettings)({
      name: document.getElementById('name').value,
      email: document.getElementById('email').value
    }, 'data');
  });
}
var userPasswordForm = document.querySelector('#updatePasswordForm');
if (userPasswordForm) {
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _auth.forgotPassword)(document.getElementById('email').value).then(function () {
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _auth.resetPassword)(token, document.getElementById('password').value, document.getElementById('passwordConfirm').value).then(function () {
  ...
  deleteBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      if (confirm('هل أنت متأكد أنك تريد حذف هذا المستخدم نهائياً؟')) {
        ...
        (0, _auth.deleteUser)(btn.dataset.id).catch(function () {
...
var currentSurahSelect = document.getElementById('currentSurah');
if (currentSurahSelect && currentSurahSelect.tagName === 'SELECT') {
  surahNames.forEach(function (name, index) {
    var opt = document.createElement('option');
    opt.value = index + 1;
    opt.innerHTML = "".concat(index + 1, ". ").concat(name);
    currentSurahSelect.appendChild(opt);
  });
}
if (document.getElementById('active-khatmah')) {
  (0, _features.manageKhatmah)();
  var createForm = document.getElementById('createKhatmahForm');
  if (createForm) {
    createForm.addEventListener('submit', function (e) {
      e.preventDefault();
      (0, _features.createKhatmah)(document.getElementById('planName').value, document.getElementById('duration').value);
    });
  }
  var deleteBtn = document.getElementById('deleteKhatmahBtn');
  if (deleteBtn) {
    deleteBtn.addEventListener('click', function () {
      if (confirm('هل أنت متأكد أنك تريد إلغاء هذه الختمة نهائياً؟')) {
        (0, _features.deleteKhatmah)();
      }
    });
  }
  var updateForm = document.getElementById('updateProgressForm');
  if (updateForm) {
    updateForm.addEventListener('submit', function (e) {
      e.preventDefault();
      var surah = document.getElementById('currentSurah').value;
      var ayah = document.getElementById('currentAyah').value;
      (0, _features.updateKhatmahProgress)(surah, ayah);
    });
  }
}
if (document.getElementById('surahs-container')) (0, _features.loadSurahs)();
if (document.getElementById('surah-name')) {
  var fullPath = window.location.pathname;
  var pathParts = fullPath.split('/');
  var param = pathParts.pop();
  if (!isNaN(param)) {
    if (fullPath.includes('/quran/')) {
      (0, _features.loadQuranPage)(parseInt(param));
    } else {
      (0, _features.startSurahReading)(parseInt(param));
    }
  }
}
if (document.getElementById('bookmarks-container')) {
  (0, _features.loadBookmarks)();
  if (typeof _features.initBookmarksSearch === 'function') {
    (0, _features.initBookmarksSearch)();
  }
}
var bookmarksList = document.getElementById('bookmarks-container');
if (bookmarksList) {
  bookmarksList.addEventListener('click', function (e) {
    var deleteBtn = e.target.closest('.delete-bookmark-btn');
    if (deleteBtn) {
      if (confirm('هل أنت متأكد من حذف هذه العلامة؟')) {
        (0, _features.deleteBookmark)(deleteBtn.dataset.id);
      }
    }
  });
}
if (document.getElementById('reciters-container')) (0, _features.loadReciters)();
if (document.getElementById('prayers-list')) (0, _features.loadPrayers)();
var aiSurahSelect = document.getElementById('ai-surah-select');
if (aiSurahSelect) {
  aiSurahSelect.innerHTML = '<option value="" selected disabled>اختر السورة...</option>';
  surahNames.forEach(function (name, index) {
    var opt = document.createElement('option');
    opt.value = index + 1;
    opt.textContent = "".concat(index + 1, ". ").concat(name);
...
if (triggerUpload && audioFile) {
  triggerUpload.addEventListener('click', function () {
    return audioFile.click();
  });
  audioFile.addEventListener('change', function () {
    if (this.files && this.files[0]) {
      uploadBtn.classList.remove('d-none');
      triggerUpload.innerText = "\u062A\u0645 \u0627\u062E\u062A\u064A\u0627\u0631: ".concat(this.files[0].name);
    }
  });
}
if (uploadBtn) {
  uploadBtn.addEventListener('click', function (e) {
    ...
    e.preventDefault();
    var surahValue = aiSurahSelect ? aiSurahSelect.value : null;
    var startAyah = ((_document$getElementB = document.getElementById('ai-start-ayah')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.value) || null;
    var endAyah = ((_document$getElementB2 = document.getElementById('ai-end-ayah')) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.value) || null;
    if (!audioFile.files[0]) return (0, _auth.showAlert)('error', 'يرجى اختيار ملف أولاً');
    if (!surahValue) return (0, _auth.showAlert)('error', 'يرجى اختيار السورة من القائمة');
    var audioUrl = URL.createObjectURL(audioFile.files[0]);
    (0, _features.checkRecitation)(audioFile.files[0], surahValue, startAyah, endAyah, audioUrl);
  });
}
var mediaRecorder;
var audioChunks = [];
...
if (recordBtn) {
  recordBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var surahValue, stream, _t;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          surahValue = aiSurahSelect ? aiSurahSelect.value : null;
          if (surahValue) {
            _context2.n = 1;
            break;
          }
          return _context2.a(2, (0, _auth.showAlert)('error', 'يرجى اختيار السورة أولاً'));
        case 1:
          _context2.p = 1;
          _context2.n = 2;
        ...
        case 2:
          ...
          mediaRecorder.onstop = function () {
            ...
            (0, _features.checkRecitation)(new File([audioBlob], "rec.webm", {
              type: "audio/webm"
            }), aiSurahSelect.value, ((_document$getElementB3 = document.getElementById('ai-start-ayah')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.value) || null, ((_document$getElementB4 = document.getElementById('ai-end-ayah')) === null || _document$getElementB4 === void 0 ? void 0 : _document$getElementB4.value) || null, audioUrl);
          };
          mediaRecorder.start();
        ...
        case 3:
          _context2.p = 3;
          _t = _context2.v;
          (0, _auth.showAlert)('error', 'يرجى تفعيل الميكروفون');
        case 4:
          _context2.n = 6;
          break;
        case 5:
...
window.showTafseer = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(surahId, ayahId) {
    var res, data, _t2;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          Swal.fire({
            title: 'جاري جلب التفسير...',
            didOpen: function didOpen() {
              Swal.showLoading();
            }
          });
          _context3.n = 1;
          return _axios.default.get("/api/v1/quran/tafseer/".concat(surahId, "/").concat(ayahId));
        case 1:
          res = _context3.v;
          data = res.data.data;
          Swal.fire({
            title: "<span class=\"text-success\" style=\"font-family: 'Amiri'\">\u062A\u0641\u0633\u064A\u0631 \u0627\u0644\u0622\u064A\u0629 ".concat(ayahId, "</span>"),
        ...
        case 2:
          ...
          Swal.fire({
            icon: 'error',
            title: 'خطأ',
            text: 'عذراً، لم نتمكن من جلب التفسير حالياً.'
          });
        case 3:
          return _context3.a(2);
      }
