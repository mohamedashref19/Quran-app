...
const path = require('path'); // تأكد من إضافة هذا السطر في أول الملف
const User = require('../models/User');
const catchAsync = require('../utils/catchAsync');

// دالة مساعدة لخدمة ملف الـ SPA الأساسي
const serveSPA = (req, res) => {
  res.sendFile(path.resolve(__dirname, '../public/index.html'));
};

exports.getLoginForm = serveSPA;
exports.getSignupForm = serveSPA;
exports.getVerifyOTPForm = serveSPA;
exports.getOverview = serveSPA;
exports.getForgotPasswordForm = serveSPA;
exports.getResetPasswordForm = serveSPA;
exports.getQuran = serveSPA;
exports.getSurah = serveSPA;
exports.getKhatmah = serveSPA;
exports.getReciters = serveSPA; 
exports.getRecitationCheck = serveSPA;
exports.getAutomaticTracker = serveSPA;
exports.getPrayers = serveSPA;
exports.getBookmarks = serveSPA;
